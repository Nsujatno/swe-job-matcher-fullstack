...
const MockAppVisualization = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-20 bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden transition-transform duration-500 ${isHovered ? 'rotate-y-2 scale-105' : 'rotate-y-0'}`}>
        {/* Header of Mock App */}
        <div className="bg-slate-800/80 border-b border-slate-700 p-4 flex items-center justify-between">
          ...
          <div className="text-xs text-slate-400 font-mono">analysis_result.json</div>
        </div>
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="text-xs bg-slate-700 px-2 py-0.5 rounded text-slate-300">TypeScript</span>
                  <span className="text-xs bg-slate-700 px-2 py-0.5 rounded text-slate-300">Rust</span>
                </div>
              </div>
            </div>
            <div className="text-right">
              <div className="text-2xl font-bold text-emerald-400">92%</div>
              <span className="text-xs text-emerald-400/70 uppercase font-bold tracking-wider">High Match</span>
            </div>
          </div>
          ...
          <div className="flex items-start justify-between p-4 rounded-xl bg-slate-800/30 border border-slate-700/50 opacity-60">
            ...
            <div className="text-right">
              ...
              <span className="text-xs text-amber-400/70 uppercase font-bold tracking-wider">Review</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-slate-800/30 border-t border-slate-700 flex justify-between items-center">
          <span className="text-xs text-slate-400 font-mono">Scanning github.com/hiring...</span>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    ...
                    <h1 className="text-transparent text-4xl bg-clip-text bg-linear-to-r from-indigo-400 to-purple-400 mb-6 ">
                        AI matches your skills <br />to the right jobs.
                    </h1>
                    <p className="text-lg text-gray-300 mb-12 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                        We scan GitHub repositories for job postings, analyze the tech stack requirements, and score them against your resume instantly.
                    </p>
